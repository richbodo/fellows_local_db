...
| C4 | [`pna_toolkit_constraints_contribution.md`](pna_toolkit_constraints_contribution.md) | Upstream PNT PR. **Depends on building C1 first** (implement → learn → contribute). | ✅ **MERGED — [PNT #18](https://github.com/richbodo/personal_network_toolkit/pull/18) (2026-06-03)** |
...
| C4 constraints upstream | 4 | ✅ merged | **the last EPIC tail** — **[PNT PR #18](https://github.com/richbodo/personal_network_toolkit/pull/18)** (merged 2026-06-03): spec/constraints.md + lint + SKILL + reference-design attestation, sharpened with PR1–6 learnings (`plans/pna_toolkit_constraints_contribution.md`) |
